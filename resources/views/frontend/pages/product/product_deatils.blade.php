                    ...
                    <div class="single_product_thumb">
                        <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                            ...
                            <ol class="carousel-indicators">
                                ...
                                @endphp
                                @foreach($photos as $key => $photo)
                                    <li class="{{ $key == 0 ? 'active' : '' }}" data-target="#product_details_slider" data-slide-to="{{ $key }}" style="background-image: url({{ $photo }});"></li>
                                @endforeach
                            </ol>
                        </div>
                    </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="single_product_desc">
                        ...
                        <div class="short_overview mb-4">
                            <h6>Overview</h6>
                            <p>{!! html_entity_decode(substr($product->summary, 0,  250)) !!}</p>
                        </div>
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane fade show active" id="description">
                                <div class="description_area">
                                    <h5>Description</h5>
                                    {!! html_entity_decode(substr($product->description, 0,  1550)) !!}
                                </div>
                            </div>
                                ...
                                <div class="single-product-area">
                                    <div class="product_image">
                                        ...
                                        @foreach($photos as $key => $photo)
                                            ...
                                            @else
                                                <img class="normal_img" src="{{ $photo }}" alt="">
                                                <img class="hover_img" src="{{ $photo }}" alt="">
                                            @endif
                                        @endforeach
                                        <!-- Product Badge -->
                                        <div class="product_badge">
