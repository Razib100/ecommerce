                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group mt-3">
                                        ...
                                        <textarea id="description" class="form-control no-resize" placeholder="Description" name="description">{{ $banner->description }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <select name="condition" class="form-control show-tick">
                                        ...
                                        <option value="pormo" {{ $banner->condition == 'pormo' ? 'selected' : ''}}>Promotional</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-12">
